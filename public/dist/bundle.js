...
/***/ "./client/components/cabecalho/index.tsx":
/*!***********************************************!*\
  !*** ./client/components/cabecalho/index.tsx ***!
  \***********************************************/
...
var Cabecalho = /** @class */ (function (_super) {
    __extends(Cabecalho, _super);
    function Cabecalho(props) {
        var _this = _super.call(this, props) || this;
        _this.handleBusca = _this.handleBusca.bind(_this);
        return _this;
    }
    Cabecalho.prototype.render = function () {
        return (React.createElement("div", { className: "App__Cabecalho" },
            React.createElement("div", { className: "App__Logo" }, this.props.nome),
            React.createElement("div", null,
                React.createElement("form", null,
                    React.createElement("input", { type: "search", onKeyPress: this.handleBusca, placeholder: "Digite o nome do produto..." })))));
    };
    Cabecalho.prototype.handleBusca = function (event) {
        if (event.key === "Enter") {
...
/***/ "./client/components/paginacao/index.tsx":
/*!***********************************************!*\
  !*** ./client/components/paginacao/index.tsx ***!
  \***********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var items_por_pagina_1 = __webpack_require__(/*! ./items-por-pagina */ "./client/components/paginacao/items-por-pagina.tsx");
exports.ItensPorPagina = items_por_pagina_1.default;
var paginacao_1 = __webpack_require__(/*! ./paginacao */ "./client/components/paginacao/paginacao.tsx");
exports.Paginacao = paginacao_1.default;


/***/ }),

/***/ "./client/components/paginacao/items-por-pagina.tsx":
/*!**********************************************************!*\
  !*** ./client/components/paginacao/items-por-pagina.tsx ***!
  \**********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var ItensPorPagina = /** @class */ (function (_super) {
    __extends(ItensPorPagina, _super);
    function ItensPorPagina(props) {
        var _this = _super.call(this, props) || this;
        _this.handleItensPorPagina = _this.handleItensPorPagina.bind(_this);
        return _this;
    }
    ItensPorPagina.prototype.render = function () {
        return (React.createElement("div", { className: "App__Itens_Por_Pagina" },
            React.createElement("select", { onChange: this.handleItensPorPagina },
                React.createElement("option", { value: "08" }, "08 produtos por p\u00E1gina"),
                React.createElement("option", { value: "16" }, "16 produtos por p\u00E1gina"),
                React.createElement("option", { value: "20" }, "20 produtos por p\u00E1gina"))));
    };
    ItensPorPagina.prototype.handleItensPorPagina = function (event) {
        this.props.updateItensPorPagina({ itensPorPagina: event.target.value });
    };
    return ItensPorPagina;
}(React.Component));
exports.default = ItensPorPagina;


/***/ }),

/***/ "./client/components/paginacao/paginacao.tsx":
/*!***************************************************!*\
  !*** ./client/components/paginacao/paginacao.tsx ***!
  \***************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var Paginacao = /** @class */ (function (_super) {
    __extends(Paginacao, _super);
    function Paginacao(props) {
        var _this = _super.call(this, props) || this;
        _this.handleClick = _this.handleClick.bind(_this);
        _this.mostrarTotalPaginas = _this.mostrarTotalPaginas.bind(_this);
        return _this;
    }
    Paginacao.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("nav", { className: "pagination" }, this.mostrarTotalPaginas())));
    };
    Paginacao.prototype.mostrarTotalPaginas = function () {
        var _a = this.props, totalPaginas = _a.totalPaginas, paginaAtual = _a.paginaAtual;
        var resultado = [];
        var activeClass;
        var props = {
            className: "item",
        ...
        resultado.push(React.createElement("a", props, "<<"));
        resultado.push(React.createElement("a", props, ">>"));
        for (var item = 0; item < totalPaginas; item++) {
            ...
            resultado.splice(resultado.length - 1, 0, React.createElement("a", props, item + 1));
        }
        return resultado;
    };
    Paginacao.prototype.handleClick = function (event) {
        event.preventDefault();
        event.stopPropagation();
        var opcao = event.target.text;
        var _a = this.props, paginaAtual = _a.paginaAtual, totalPaginas = _a.totalPaginas;
        var resultado;
        switch (opcao) {
            case "<<":
...
/***/ "./client/components/produtos/index.tsx":
/*!**********************************************!*\
  !*** ./client/components/produtos/index.tsx ***!
  \**********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var item_1 = __webpack_require__(/*! ./item */ "./client/components/produtos/item.tsx");
exports.ProdutoItem = item_1.default;
var lista_1 = __webpack_require__(/*! ./lista */ "./client/components/produtos/lista.tsx");
exports.ProdutoLista = lista_1.default;
var mensagem_1 = __webpack_require__(/*! ./mensagem */ "./client/components/produtos/mensagem.tsx");
exports.Mensagem = mensagem_1.default;
var pesquisado_1 = __webpack_require__(/*! ./pesquisado */ "./client/components/produtos/pesquisado.tsx");
exports.ProdutoPesquisado = pesquisado_1.default;


/***/ }),

/***/ "./client/components/produtos/item.tsx":
/*!*********************************************!*\
  !*** ./client/components/produtos/item.tsx ***!
  \*********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var ProdutoItem = /** @class */ (function (_super) {
    __extends(ProdutoItem, _super);
    function ProdutoItem(props) {
        return _super.call(this, props) || this;
    }
    ProdutoItem.prototype.render = function () {
        var _a = this.props.produto.url, servidor = _a.servidor, imagem = _a.imagem;
        var _b = this.props.produto, produto = _b.produto, precoAnterior = _b.precoAnterior, precoAtual = _b.precoAtual, tipo = _b.tipo;
        return (React.createElement("div", { className: "App__Produto_Item" },
            React.createElement("div", { className: "App__Produto_Imagem" },
                React.createElement("img", { src: servidor + imagem })),
            React.createElement("div", { className: "App__Produto_Item__Informacao" },
                React.createElement("div", { className: "App__Produto_Item__Descricao" },
                    React.createElement("span", { className: "App__Produto_Item__Nome" }, produto),
                    React.createElement("span", { className: "App__Produto_Item__Tipo" }, tipo)),
                React.createElement("div", { className: "App__Produto_Item__Preco" },
                    React.createElement("span", { className: "App__Produto_Item__Preco_Anterior" }, this.formatarMoeda(precoAnterior)),
                    React.createElement("span", { className: "App__Produto_Item__Preco_Atual" }, this.formatarMoeda(precoAtual))))));
    };
    ProdutoItem.prototype.formatarMoeda = function (valor) {
        return "R$ " + valor.toFixed(2);
    };
    return ProdutoItem;
}(React.Component));
exports.default = ProdutoItem;


/***/ }),

/***/ "./client/components/produtos/lista.tsx":
/*!**********************************************!*\
  !*** ./client/components/produtos/lista.tsx ***!
  \**********************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var item_1 = __webpack_require__(/*! ./item */ "./client/components/produtos/item.tsx");
var ProdutoLista = /** @class */ (function (_super) {
    __extends(ProdutoLista, _super);
    function ProdutoLista(props) {
        return _super.call(this, props) || this;
    }
    ProdutoLista.prototype.render = function () {
        var resultado = this.props.produtos.length > 0 ?
            this.props.produtos.map(function (produto) {
                return React.createElement(item_1.default, { key: produto.id, produto: produto });
            }) :
            React.createElement("div", { className: "App__Produto_Nao_Encontrado" },
                React.createElement("span", null, "Produto n\u00E3o encontrado!"),
                React.createElement("img", { src: "https://openclipart.org/download/301359/errname1.svg", width: "376px", height: "376px" }));
        return (React.createElement("div", { className: "App__Produto_Lista" }, resultado));
    };
    ProdutoLista.prototype.componentWillMount = function () {
        this.props.obterProdutos();
    };
    ProdutoLista.prototype.componentWillReceiveProps = function (nextProps) {
        if (nextProps.itensPorPagina !== this.props.itensPorPagina ||
...
exports.default = ProdutoLista;


/***/ }),

/***/ "./client/components/produtos/mensagem.tsx":
/*!*************************************************!*\
  !*** ./client/components/produtos/mensagem.tsx ***!
  \*************************************************/
/*! no static exports found */
...
var Mensagem = /** @class */ (function (_super) {
    ...
    Mensagem.prototype.render = function () {
        var mensagem = this.props.totalProdutos > 1 ?
            "Produtos Encontrados" : "Produto Encontrado";
        return (React.createElement("div", { className: "App__Produto_Lista__Mensagem" },
            this.props.totalProdutos,
            " ",
            mensagem));
    };
    return Mensagem;
...
/***/ "./client/components/produtos/pesquisado.tsx":
/*!***************************************************!*\
  !*** ./client/components/produtos/pesquisado.tsx ***!
  \***************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var ProdutoPesquisado = /** @class */ (function (_super) {
    __extends(ProdutoPesquisado, _super);
    function ProdutoPesquisado(props) {
        return _super.call(this, props) || this;
    }
    ProdutoPesquisado.prototype.render = function () {
        return (React.createElement("div", { className: "App__Produto_Pesquisado" }, this.props.busca || "Lista de Produtos"));
    };
    return ProdutoPesquisado;
}(React.Component));
exports.default = ProdutoPesquisado;
...
var cabecalho_1 = __webpack_require__(/*! ./components/cabecalho */ "./client/components/cabecalho/index.tsx");
var paginacao_1 = __webpack_require__(/*! ./components/paginacao */ "./client/components/paginacao/index.tsx");
var produtos_1 = __webpack_require__(/*! ./components/produtos */ "./client/components/produtos/index.tsx");
...
var App = /** @class */ (function (_super) {
    ...
    function App(props) {
        ...
        _this.obterProdutos = _this.obterProdutos.bind(_this);
        _this.updateStore = _this.updateStore.bind(_this);
        _this.updateItensPorPagina = _this.updateItensPorPagina.bind(_this);
        return _this;
    }
    App.prototype.render = function () {
        return (React.createElement("div", { className: "App" },
            React.createElement(cabecalho_1.default, { nome: "mmartan", busca: this.state.busca, updateStore: this.updateStore }),
            React.createElement(produtos_1.ProdutoPesquisado, { busca: this.state.busca }),
            React.createElement(produtos_1.Mensagem, { totalProdutos: this.state.totalProdutos }),
            React.createElement(produtos_1.ProdutoLista, { produtos: this.state.produtos, busca: this.state.busca, itensPorPagina: this.state.itensPorPagina, obterProdutos: this.obterProdutos, paginaAtual: this.state.paginaAtual }),
            React.createElement("footer", { className: "App__Rodape" },
                React.createElement(paginacao_1.ItensPorPagina, { itensPorPagina: this.state.itensPorPagina, updateItensPorPagina: this.updateItensPorPagina, obterProdutos: this.obterProdutos }),
                React.createElement(paginacao_1.Paginacao, { totalPaginas: this.state.totalPaginas, paginaAtual: this.state.paginaAtual, updateStore: this.updateStore }))));
    };
    App.prototype.updateStore = function (value) {
        this.setState(value);
    };
    App.prototype.updateItensPorPagina = function (itensPorPagina) {
        var num = parseInt(itensPorPagina["itensPorPagina"], 10);
        this.setState({ itensPorPagina: num });
    };
    App.prototype.obterProdutos = function () {
        var _this = this;
        var _a = this.state, itensPorPagina = _a.itensPorPagina, busca = _a.busca, paginaAtual = _a.paginaAtual;
        var SEARCH_URL = API_URL + "/produtos/?";
        if (itensPorPagina) {
